...
# const evtSource = new EventSource("http://localhost:5000/scan", {
#   method: "POST",
#   body: JSON.stringify({ url: "http://testphp.vulnweb.com" }),
#   headers: { "Content-Type": "application/json" }
# });
# evtSource.onmessage = function(event) {
#   const data = JSON.parse(event.data);
#   if (data.done) {
#     // Quét xong, render summary
#   } else {
#     // Render từng kết quả mới
#   }
# };